...
public class FlashLoader extends AsynchronousAssetLoader<FlashElements, com.gleejet.sun.utils.loader.FlashParameter>
{
    ...
    @Override
    public Array<AssetDescriptor> getDependencies(final String s, final FileHandle fileHandle, final com.gleejet.sun.utils.loader.FlashParameter flashParameter) {
        return null;
    }
    
    @Override
    public void loadAsync(final AssetManager assetManager, final String s, final FileHandle fileHandle, final com.gleejet.sun.utils.loader.FlashParameter flashParameter) {
        try {
    ...
    @Override
    public FlashElements loadSync(final AssetManager assetManager, final String s, final FileHandle fileHandle, final com.gleejet.sun.utils.loader.FlashParameter flashParameter) {
