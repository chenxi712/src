...
public class JsonLoader extends AsynchronousAssetLoader<JsonValue, JsonParameter>
{
    ...
    @Override
    public Array<AssetDescriptor> getDependencies(final String s, final FileHandle fileHandle, final com.fxb.razor.utils.loader.JsonParameter jsonParameter) {
        return null;
    }
    ...
    @Override
    public JsonValue loadSync(final AssetManager assetManager, final String s, final FileHandle fileHandle, final com.fxb.razor.utils.loader.JsonParameter jsonParameter) {
        return this.value;
    }
